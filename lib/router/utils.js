...
function defineComponentWithName(component, path) {
  ...
  // 如果已经处理过名称定义了，则无需再处理
  if (hasOwnProperty(component, DECLARE_NAME_STUB)) {
    return component
  }
...
export function getComponentDeclaredName(component) {
  ...
  } else if (component && hasOwnProperty(component, DECLARE_NAME_STUB)) {
...
export function getComponentRoutePath(component) {
  ...
  if (component && hasOwnProperty(component, ROUTE_PATH_STUB)) {
